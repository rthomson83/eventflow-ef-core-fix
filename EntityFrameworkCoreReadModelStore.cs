...
/// <summary>
/// This replaces the EventFlow.EntityFramework implementation of IEntityFrameworkReadModelStore<TReadModel> to work around package compatibility issues using EF Core 6
/// </summary>
/// <typeparam name="TReadModel"></typeparam>
/// <typeparam name="TDbContext"></typeparam>
public class EntityFrameworkCoreReadModelStore<TReadModel, TDbContext> :
    ...
    where TDbContext : DbContext
{
    ...
    public EntityFrameworkCoreReadModelStore(
        ...
        bool tracking = false)
    {
        ...
        {
            Log.Verbose(() =>
                $"Could not find any Entity Framework read model '{readModelType.PrettyPrint()}' with ID '{id}'");
        ...
        Log.Verbose(() =>
            $"Found Entity Framework read model '{readModelType.PrettyPrint()}' with ID '{id}' and version '{version}'");
        ...
        ReadModelUpdate readModelUpdate)
    {
        ...
        Log.Verbose(() =>
            $"Updated Entity Framework read model {typeof(TReadModel).PrettyPrint()} with ID '{readModelId}' to version '{readModelEnvelope.Version}'");
    }
